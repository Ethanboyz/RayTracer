...
class OpenSimplex2S {
    ...
    static constexpr double N2 = 0.05481866495625118;
    static constexpr double N3 = 0.2781926117527186;
    static constexpr double N4 = 0.11127401889945551;
    ...
    static LatticePoint3D LOOKUP_3D_EXTRA[8][13];
    ...
    */
    [[nodiscard]] double noise2_Base(double xs, double ys) const;
    ...
    */
    [[nodiscard]] double noise3_BCC(double xr, double yr, double zr) const;
    ...
    */
    [[nodiscard]] double noise4_Base(double xs, double ys, double zs, double ws) const;
...
public:
    ...
    */
    [[nodiscard]] double noise2_XBeforeY(double x, double y) const;
    ...
    */
    [[nodiscard]] double noise3_Classic(double x, double y, double z) const;
    ...
    */
    [[nodiscard]] double noise3_XYBeforeZ(double x, double y, double z) const;
    ...
    */
    [[nodiscard]] double noise3_XZBeforeY(double x, double y, double z) const;

    /**
    * 4D SuperSimplex noise, classic lattice orientation.
    */
    [[nodiscard]] double noise4_Classic(double x, double y, double z, double w) const;
    ...
    */
    [[nodiscard]] double noise4_XYBeforeZW(double x, double y, double z, double w) const;

    /**
    * 4D SuperSimplex noise, with XZ and YW forming orthogonal triangular-based planes.
    * Recommended for 3D terrain, where X and Z (or Y and W) are horizontal.
    */
    [[nodiscard]] double noise4_XZBeforeYW(double x, double y, double z, double w) const;
    ...
    */
    [[nodiscard]] double noise4_XYZBeforeW(double x, double y, double z, double w) const;
};
